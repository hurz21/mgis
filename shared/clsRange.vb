...
Public Class clsRange
    ...
    Public Function xcenter() As Double
        Return xl + (xdif() / 2)
    End Function
    Public Function ycenter() As Double
        Return yl + (ydif() / 2)
    End Function
    ...
    Public Overrides Function toString() As String
        ...
        If xl.ToString.StartsWith("32") Then
            l("fehler: xkooredinate mit 32")
        End If
        Return Show$
    End Function
    ...
    Friend Function isSameAs(aktrange As clsRange) As Boolean
        Try
            ...
            l("isSameAs---------------------- ende")
        Catch ex As Exception
            l("Fehler in clsRange.isSameAs: ", ex)
            Return False
        End Try
    End Function
End Class
