...
Module createPDF
    ...
    Function dateiNachMeineBilderKopieren(pdfdatei As String) As String
        ...
        Catch ex As Exception
            l("Fehler in dateiNachMeineBilderKopieren: ", ex)
            Return pdfdatei
        End Try
    End Function
    ...
    Public Function makeandloadPDF(masstabsModus As String, PDF_PrintRange As clsRange,
                              ...
                              paintPNG As Boolean, hochaufloesend As Boolean, isa4Formatchecked As Boolean,
                                   ...
                                   ByRef localfileFullname As String, pdflayers As List(Of clsLayerPres)) As Boolean
        ...
        Try
            ...
            Return True
        Catch ex As Exception
            l("Fehler in makeandloadPDF a: ", ex)
            Return False
        End Try
    End Function
    ...
    Private Function genPDFonServer(paintPNG As Boolean, hochaufloesend As Boolean,
                                ...
                                PDF_PrintRange As clsRange, pdf_bemerkung As String, pdf_ort As String, druckmasstab As Double,
                                PDFlayers As List(Of clsLayerPres)) As String
        Dim ergebnis As String = ""
        Try
    ...
    Function getNameOfDownloadFile(pdfDatei As String) As String
        ...
        '    zieldatei = zieldatei.Replace("\\w2gis02\gdvell\cache\", "")
    ...
    Friend Function calcPDFrahmenPositionInPixel(myPDFRect As Rectangle, mittelPunkt As myPoint) As myPoint
        ...
        Catch ex As Exception
            l("Fehler in calcPDFrahmenPositionInPixel: mittelPunkt:" & mittelPunkt.toString & ", " & myPDFRect.ToString, ex)
            Return Nothing
        End Try
    End Function
    Private Function genaufrufBuildMapfile(paintPNG As Boolean, hochaufloesend As Boolean,
                                           ...
                                           FSTname As String, FSTabstract As String,
                                           pdflayers As List(Of clsLayerPres)) As String
        ...
        Try
            ...
            emplayers = layersselected_copieren(pdflayers)
            ...
            Return aufruf
        Catch ex As Exception
            l("Fehler in genaufrufBuildMapfile: ", ex)
            Return ""
        End Try
    End Function
