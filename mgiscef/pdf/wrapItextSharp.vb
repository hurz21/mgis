...
Module wrapItextSharp
    ...
    Friend Sub createSchnellEigentuemer(text As String, ByRef ausgabedatei As String, verbotsString As String, lokalitaet As String, lage As String)
        ...
        Try
            ...
            addChunk2Dok(oDoc, "Datum: " & Format(Now, "dd.MM.yyyy") & ", " & GisUser.nick, bf, 8, zeilenabstand_gross + 4)
