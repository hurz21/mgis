...
Module createPDF
    ...
    Public Function makeandloadPDF(masstabsModus As String, PDF_PrintRange As clsRange,
                              ...
                              paintPNG As Boolean, hochaufloesend As Boolean, isa4Formatchecked As Boolean,
                                   schnelldruck As Boolean, ByRef pdfDatei As String, mitsuchobjekt As Boolean) As Boolean
        l("in makeandloadPDF--------------------------")
        PicturesPath = System.Environment.GetFolderPath(Environment.SpecialFolder.MyPictures)
        Dim mapfileStringtext As String
        mapfileStringtext = createMapfilePDF(paintPNG, hochaufloesend, mitsuchobjekt)
        ...
        If pdfWurdeErzeugt Then
            If paintPNG Then
                ...
                OpenDokumentWith(strGlobals.paintProgramm, kopie)
                pdfDatei = kopie
                Return True
            End If
            ...
            Else
                ...
                If schnelldruck Then
                    Dim param As String
                    param = "start /B ""Drucken"" """ & strGlobals.pdfReader & """ /t """ & pdfDatei & """"
                    Dim datei As String
