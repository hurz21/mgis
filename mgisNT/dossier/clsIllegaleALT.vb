Public Class clsIllegaleALT
    Friend Shared Function getIllegaleALTInfo4point(winpt As myPoint, ByRef rESULT_text As String,
                                    ByRef kurz As String, ByRef pdf As String, schematabelle As String) As Boolean
        Dim resulttext As String = ""
        Try
            l(" getIllegaleALTInfo4point ---------------------- anfang")
            Return getIllegaleALTExtracted(rESULT_text, kurz, pdf, schematabelle, winpt)
        ...
        End Try
    End Function
    Private Shared Function getIllegaleALTExtracted(ByRef rESULT_text As String, ByRef kurz As String,
                                       ByRef pdf As String,
        ...
        Try
            ...
            Else
                ...
                For i = 0 To dt.Rows.Count - 1
                    kurz = kurz & ", " & clsDBtools.fieldvalue(dt.Rows(i).Item("aktenzeichen")).Trim
                    pdf = "" 'clsDBtools.fieldvalue(dt.Rows(i).Item("vid")).Trim
                    'wsgpdf = wsgpdf & "," & datei
                Next
                rESULT_text = bildeIllegaleALTINFO(dt)
                Return True
            End If
