...
Public Class winDetailAdressSuche
    ...
    '    Dim sname As String = item2.Row.ItemArray(0).ToString.Trim
    '    Dim scode As Integer = CInt(item2.Row.ItemArray(1).ToString.Trim)

    '    Dim mesresult As New MessageBoxResult
    '    mesresult = showHausnr(sname, scode)
    '    Dim hausnrListe As New List(Of clsFlurauswahl)
    '    hausnrListe = initHausnrliste(adrREC.dt)
        ...
        Try
            ...
            If adrREC.dt.Rows.Count < 1 Then
                ...
                If mesresult = MessageBoxResult.Cancel Then
                    ...
                    'e.Handled = True
                Else
                    '  Dim koordinatenstring As String =
                    retunrvalue = True
                    Close()
    ...
    Private Sub handelhausnr(hausnrkombi As String, rechts As String, hoch As String, weistauf As String)
