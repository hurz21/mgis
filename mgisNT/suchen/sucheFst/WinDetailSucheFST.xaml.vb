...
Public Class WinDetailSucheFST
    ...
    Private Sub gemarkungGewaehlt(theID As String, displaytext As String)
        Try
            l(" MOD ---------------------- anfang")
            'tbGemarkung.Text = displaytext.Trim 
    ...
    Sub initFSTliste(ziffern As String)
        ...
        If cbFSTHist.IsChecked Then
            ...
            historyLast = True
        Else
            dtaktuell = holeZNDT(WinDetailSucheFST.AktuelleBasisTabelle, "")
            aktFST.normflst.istHistorisch = False
            historyLast = False
        End If
        ...
        'If ziffern = String.Empty Then
        'If fstkombis.Count < 1 Then

        'Else
        '    'dt2objFst(dtaktuell)
        '    If ziffern = "alle" Then
        '        'fstklein = getKleineFstListe(fstkombis, ziffern)
        '        lvFstkombi.ItemsSource = fstkombis
        '    Else
        '        fstklein = getKleineFstListe(fstkombis, ziffern)
    ...
    Private Sub btnEigentuemer_Click(sender As Object, e As RoutedEventArgs)
        ...
        If cbSchnellEigentuemer.IsChecked Then
            ...
            Else
                ...
                EigentuemerPDF = clsFSTtools.erzeugeundOeffneEigentuemerPDF(tbWeitergabeVerbot.Text, albverbotsString)
