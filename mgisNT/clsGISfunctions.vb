Public Class clsGISfunctions
    ...
    Public Function GoogleMapsAufruf_MittelpunktMItPunkteUebergabe(ByVal bbox As clsRange, htmlformat As Boolean) As String
        ...
        templateFile = strGlobals.cPtestMgis & "\Infowindow.htm" ' mgisroot & "\Infowindow.htm"
        nachricht("2")
    ...
    Public Function GoogleMapsAufruf_MittelpunktMItPunkteUebergabe(ByVal bbox As clsRange, htmlformat As Boolean,
        ...
        End If
    End Function
    Public Function GoogleMapsAufruf_Extern(ByVal bbox As clsRange, htmlformat As Boolean) As String
        nachricht("GoogleMapsAufruf_MittelpunktMItPunkteUebergabe -----------------------------------")
        Dim aktp As New myPoint
        Dim abstand As Double
        Dim templateFile As String
