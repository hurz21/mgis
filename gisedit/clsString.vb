Public Class clsString
    Shared Function getTimestampShort() As String
        Return Now.ToString("_yy_MM_dd_HHmmss")
    End Function
    Public Shared Function getTimestamp() As String
        Return Now.ToString("yyyy-MM-dd_HHmmss_fff_tt")
    End Function
...
ende:
    ...
    Friend Shared Function removeLastChar(text As String) As String
        ...
        Catch ex As Exception
            l("Fehler in removeLastChar: " & ex.ToString())
            Return text
        End Try
    End Function
