...
Class clsTooltipps
    Shared Sub setTooltipSuchobjektPolygon(tb12 As Polygon, popuplevel As String)
        ...
        Try
            ...
            mi.BeginInit()
            mi.UriSource = New Uri("c:\ptest\mgis\bilder\suchobjekt.png")
            mi.EndInit()
            td.Source = mi
            ...
            mi1.BeginInit()
            mi1.UriSource = New Uri("c:\ptest\mgis\bilder\suchobj2.png")
            mi1.EndInit()
            td2.Source = mi1
    ...
    Shared Sub setTooltipExplorerButton(tb12 As Button, popuplevel As String)
        ...
        Try
            ...
            Dim mi As BitmapImage = New BitmapImage()
            mi.BeginInit()
            mi.UriSource = New Uri("c:\ptest\mgis\bilder\explorer.png")
            mi.EndInit()
            td.Source = mi
    ...
    Shared Sub setTooltipSuchobjLoeschenButton(tb12 As CheckBox, popuplevel As String)
        ...
        Try
            ...
            Dim mi As BitmapImage = New BitmapImage()
            mi.BeginInit()
            mi.UriSource = New Uri("c:\ptest\mgis\bilder\suchobjekte_3sorten.png")
            mi.EndInit()
            td.Source = mi
    ...
    Friend Shared Sub setTooltipVogel(tb12 As Button, popuplevel As String)
        ...
        Try
            ...
            Dim mi As BitmapImage = New BitmapImage()
            mi.BeginInit()
            mi.UriSource = New Uri("c:\ptest\mgis\bilder\vogeldrehen.png")
            mi.EndInit()
            td.Source = mi
    ...
    Friend Shared Sub setTooltipAktvorgang(spVID As DropDownButton, popuplevel As String)
        ...
        Try
            ...
            Dim mi As BitmapImage = New BitmapImage()
            mi.BeginInit()
            mi.UriSource = New Uri("c:\ptest\mgis\bilder\vorgangsmenue.png")
            mi.EndInit()
            td.Source = mi
