Module scaleScreen
    ...
    Friend Sub initMassstab(mapCanvas_Width As Double, mapCanvas_Height As Double, bildschirmbreite As Double)        '  
        Dim ScreenMeterProPixel As Double
        'ScreenMeterProPixel = Scale_bildschirmBreiteInMeter / CLng(System.Windows.SystemParameters.PrimaryScreenWidth) ' 1920
        ScreenMeterProPixel = Scale_bildschirmBreiteInMeter / CLng(bildschirmbreite) ' 1920
