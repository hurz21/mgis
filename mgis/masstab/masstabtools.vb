Module masstabtools
    ...
    Function calcNewScreenScale(massstabszahl As Integer,
        ...
        Catch ex As Exception
            l("fehler in calcNewScreenScale" & ex.ToString)
            Return ""
        End Try
    End Function
    ...
    Friend Sub initDruckMasstabCombo(rbFormatA4_IsChecked As Boolean,
        ...
        For i = 0 To a.Count - 1
            ...
            nm.tagVal = CInt(b(1).Trim)
            nm.displayVal = a(i)
            test = calcNewScreenScale((nm.tagVal), rectWidthInPixel, rectHoheInPixel,
