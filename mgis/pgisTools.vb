...
Module pgisTools
    ...
    Private Sub mitFehlerMail(ByVal text As String, ByVal anhang As String)
        If text.ToLower.StartsWith("fehler") Or text.ToLower.StartsWith("error") Or
            ...
            text = Now.ToString & Environment.NewLine &
                   "; Version: <" & myglobalz.mgisVersion & ">" & Environment.NewLine &
                   text
    ...
    Public Function holeFlureDT() As DataTable
        ...
        End Try
    End Function
    Public Function holeZaehlerDT(schematabelle As String) As DataTable
        Dim SQL = "select distinct zaehler  from " & schematabelle & " " &
    ...
    Friend Function getPunkt4fs(fS As String) As myPoint
        ...
        Try
            ...
            Dim SQL = "SELECT ST_AsText(ST_PointOnSurface(geom)) FROM flurkarte.basis_f where fs='" & fS & "'"
            dt = getDTFromWebgisDB(SQL, "postgis20")
