...
Public Class clsGemarkungsParams
  ...
  Property gemarkungstext$()
    ...
    End Set
  End Property
  Private _gemeindetext$
  Property gemeindetext$()
    Get
      Return _gemeindetext$
    End Get
    Set(ByVal value$)
      _gemeindetext$ = value
    End Set
  ...
  Property gemeindenr%()
    ...
    End Set
  End Property
  Private _gemarkungskuerzel$
  Property gemarkungskuerzel$()
    Get
      Return _gemarkungskuerzel$
    End Get
    Set(ByVal value$)
      _gemarkungskuerzel$ = value
    End Set
  End Property

  Private _gemarkungsPLZ$
  Property gemarkungsPLZ$()
    Get
      Return _gemarkungsPLZ
    End Get
    Set(ByVal value$)
      _gemarkungsPLZ = value
    End Set
  End Property
  Sub init()
  ...
  Public Function nummer2gemeindename(ByVal nr$) As String
    ...
    End Try
  End Function
  Public Function liegtGemeindeImKreisOffenbach(ByRef gemname$) As Boolean
    ' in: s$ gemeindename
    ...
    Try
      ...
      gemname = gemname.Replace(Chr(34), "")
      gemname = gemname.Replace(" ", "")
      If gemname = "mühlheim am main" Then gemname = "mühlheim"
      If gemname = "mühlheimammain" Then gemname = "mühlheim"
      If gemname = "muehlheim" Then gemname = "mühlheim"
      If gemname = "roedermark" Then gemname = "rödermark"
      If gemname = "neu-isenburg" Then gemname = "neuisenburg"
      If gemname.EndsWith("hlheim") Then gemname = "mühlheim"
      If gemname.EndsWith("dermark") Then gemname = "rödermark"
