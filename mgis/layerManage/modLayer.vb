...
#End If
    ...
    Friend Function createMapfilePDF(paintPNG As Boolean, hochaufloesend As Boolean) As String
        ' /fkat/flurkarte/flurkarte2016/flurkarte2016_header.map"
        'MAP
        'INCLUDE '/inetpub/wwwroot/buergergis/mapfile/header.map',
        'INCLUDE '/fkat/boden/bodentyp/bodentyp_layer.map',,
        ...
        Try
            ...
            If paintPNG Or hochaufloesend Then
                sb.AppendLine("INCLUDE " & PNGdruck_MapFileHeaderr)
            Else
                sb.AppendLine("INCLUDE " & PDFdruck_MapFileHeaderr)
            End If
            ...
            For Each nlayer As clsLayerPres In emplayers
                ...
                End If
            Next
            ' sb.AppendLine("INCLUDE '/inetpub/wwwroot/buergergis/mapfile/paradigma/d_q_s_rahmen.map'")
            If hochaufloesend Then
...
#End If
    ...
    Friend Function getHintergrund(binImInternet As Boolean) As List(Of clsLayerPres)
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            tlayer.aid = CInt(clsDBtools.fieldvalue(dt.Rows(i).Item("aid")))
