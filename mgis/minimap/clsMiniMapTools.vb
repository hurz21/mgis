Public Class clsMiniMapTools
    ...
    Private Shared Sub handleMouseDownImagemap(KoordinateKLickpt As Point?, aktPolygonTag As String)
        Dim javascriptOriginalstring As String = ""
    ...
    Shared Sub handlejavascript(javascriptOriginalstring As String)
        ...
        Dim featureclass As String, htmlTemplate As String
        ...
        Try
            ...
            result = execDB4objabfrage(javascriptOriginalstring, aktObjID, istklickbar, buttonINfostring,
                                                 ...
                                                 featureclass, htmlTemplate, strAktfs)
            ...
            If istKlassischeHTMLTemplate Then
                klassischeDBabfrage(aktObjID, featureclass, htmlTemplate)
            Else
    ...
    Shared Sub dbAbfrageDiaglogPrep(buttonINfostring As String, titel As String)
        ...
        If gesamtSachdatList Is Nothing Then
            ...
            Exit Sub
        End If
        Dim temp As FlowDocument
        Dim isUserLayer As Boolean = False
        Dim freiDB As winDBabfrage
        Try
            temp = nsMakeRTF.rtf.makeRtfDoku(gesamtSachdatList, titel, CType(aktObjID, String))
            l("dbAbfrageDiaglogPrep---------------------- anfang")
            isUserLayer = layerActive.aid = GisUser.userLayerAid
            freiDB = New winDBabfrage("", "text", buttonINfostring, isUserLayer, temp)
            freiDB.Show()
    ...
    Private Shared Function execDB4objabfrage(JSoriginal As String, ByRef objID As Integer, ByRef istklickbar As Boolean,
                                             ...
                                             ByRef istKlassischeHTMLTemplate As Boolean, ByRef featureclass As String,
                                              ByRef htmlTemplate As String, ByRef aktfs As String) As String
        ...
        Try
            ...
            If layerActive.aid < 1 Then
                ...
                End If
            End If
            ergebnis = getDBrecord(layerActive.aid, objID, buttonINfostring, tabnr, aktfs)
    ...
    Private Shared Function getIstKlassische(jSoriginal As String) As Boolean
        Try
            l("istKlassische---------------------- anfang")
            If jSoriginal.ToLower.Contains("show_mydb_in_window") Then
                Return True
            Else
                Return False
            End If
