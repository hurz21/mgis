...
Public Class clsBplan
    Public Shared bplanroot As String = "\\w2gis02\gdvell\fkat\bplan"
    Shared Function getBplanInfo4point(winpt As myPoint, ByRef dt As DataTable, schematabelle As String) As Boolean
        Try
    ...
    Private Shared Function BplanPDFanbieten(dt As DataTable, index As Integer, ByRef RESULT_dateien As List(Of clsGisresult), ByRef plannr As String) As Boolean
        Try
