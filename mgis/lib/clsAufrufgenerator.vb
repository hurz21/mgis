...
Public Class clsAufrufgenerator
    ...
    Shared Function bildeAufrufEinzelOS(os_tabelledef As clsTabellenDef) As String
        Try
            ...
            'sb.Append("/websys/mapfile/system/paradigma_hervorhebungflaeche.map".Replace("\", "/"))
            sb.Append("/nkat/vorlage/paradigma_hervorhebungflaeche.map".Replace("\", "/"))
    ...
    Function ImapGenaufrufMAPserver(mapfile As String) As String
        Try
            ...
            Dim sb As New Text.StringBuilder
            sb.Append(Domainstring)
            sb.Append("/cgi-bin/mapserv70/mapserv.exe?" &
    ...
    Function genOutfileFullName(ByVal cachedir As String, endung As String) As Boolean
        ...
        Try
            ...
            Return True
        Catch ex As Exception
            nachricht("Fehler genoutfilename: " & ex.ToString)
            Return False
        End Try
    End Function
    ...
    Public Shared Function istCacheOK(ByRef cachedir$) As Boolean
        ...
        Try
            ...
            Return True
        Catch ex As Exception
            nachricht("Fehler istcacheok: " & ex.ToString)
            Return False
        End Try
    End Function
